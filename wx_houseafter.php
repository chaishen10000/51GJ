  ...
  <?php
	...
	if (!$_SESSION['openid']) {
		...
		foreach ($row as $key => $value) {
			...
			$strtemp.= "<li class='table-view-cell addressafterjs' data-f='".$value['f']."' data-ID='" . $value['property_ID'] . "'> <i class='ico-map-marker'></i><div class='ipt'/>";
			$strtemp.= $address;
			$strtemp.= '</div></li>';
		}
...
<form name="fm1" method="post" action="" id="fm1" novalidate>
    ...
    <div class="banner"> <a href="/wx-pages/fwjs.htm" data-ignore="push">
      <div> <img src="/wx-pages/images/sd_after.jpg" width="100%" alt="" /> </div>
    ...
    <div class="table-mod">
        ...
        <li class='table-view-cell houseservice '> <i class='ico-tags'></i>
           <div class='ipt'/>
    ...
    <ul class="table-view card">
        <?php echo $strtemp;?>
        <li class='table-view-cell addressafterjs'> <i class='ico-map-marker'></i>
        <div class='ipt'/>
    ...
    <input type="hidden" name="type" id="type" value="住后整理" />
