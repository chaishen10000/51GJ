...
(function ($) {      
	...
	function resetIndex(){
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="datePage" class="page">'+
                    '<section>'+
                        '<div id="datetitle"><strong>请选择服务时间</strong></div>'+
        ...
        function addTimeStyle(){
			...
			_windowHeight = document.body.scrollHeight; //获取当前窗口高度 
			_windowWidth = document.body.clientWidth; //获取当前窗口宽度
			_popupHeight = $("#datePage").height();//获取弹出层高度 
			_popupWeight = $("#datePage").width();//获取弹出层宽度 
			_posiTop = (_windowHeight - _popupHeight)-100; 
			_posiLeft = (_windowWidth - _popupWeight)/2;
            $("#datePage").css("top",_posiTop);
			$("#datePage").css("bottom","0px");
