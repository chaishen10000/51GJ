...
if (!$_SESSION['openid']) {
	...
	foreach ($row as $key => $value) {
		...
		$strtemp .= "<p class='ipt propertylist'><a href='wx_cardetail.php?property_ID=".$value['property_ID']."'>". $value['f'] ."</a></p>";
    ...
    <div class="table-mod">
      ...
      <ul class="table-view card">
        <li class="table-view-cell"> <i class="ico-remark"></i>
          <input type="text" class="ipt" name="a" id="a" placeholder="车辆所有人（须与行驶证一致）"/>          
        </li>
        <li class="table-view-cell"> <i class="ico-remark"></i>
        ...
        <li class="table-view-cell"> <i class="ico-remark"></i>
          <input class="ipt" type="text" name="e" id="e" placeholder="车险到期日期（如：20160809）"/>
        </li>
        <li class="table-view-cell"> <i class="ico-remark"></i>
          <input class="ipt" type="text" name="f" id="f" placeholder="厂商及型号 "/>
        </li>
        ...
        <li class="table-view-cell" id="coupons_view">
          ...
          <div class="imagup">
            ...
            <div class="imagup_btn1"> &nbsp;<span id="weixin">选择行驶证图片</span>
            </div>
      ...
      <ul class="table-view card">
        <div class="pull-right" id="clsShow">
          <button class="btn btn-positive btn-positive2" type="button" style="background-color:#825623; border-color:#825623" id="property_updata" onclick="javascript:submitValidate_c();">确认添加</button>
        </div>
      </ul>
    </div>
  </div>
