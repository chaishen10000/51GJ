...
class db { 
	...
	{
		$date = date("Y-m");
	    $log_name = "./notify_url_$date.log";//log文件路径
	    $log_error =  "notify_error_$date.log";//log文件路径
	    $fp = fopen($log_name,"a");
	    flock($fp, LOCK_EX) ;
